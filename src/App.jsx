                ...
                <Row rowProperties=" d-flex justify-content-center h-100">
                    <Col colProperties="-6 d-flex justify-content-center align-items-center">
                        <CounterBody title="Counter App">
                            <div id="counterDisplay" className="counter-display d-inline-block rounded-3 text-bg-secondary px-5 py-4 my-3">
                                <span className="display-2 fw-bold">5</span>
                            </div>

                            <div id="counterControls" className="counter-controls d-flex justify-content-center align-items-center">
